        ...
        <div class="row px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a class="btn d-flex align-items-center justify-content-between bg-warning w-100" data-toggle="collapse" href="#navbar-vertical" style="height: 65px; padding: 0 30px;">
                    <span class="h1 text-uppercase text-white bg-dark rounded  px-2">Jizzy</span>
                    <span class="h1 text-uppercase text-dark bg-white rounded  px-2">Shop</span>
                </a>
            </div>
            <div class="col-lg-9">
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            <div class="dropdown d-inline">
                                ...
                                <ul class="dropdown-menu">
                                  <li class="my-2"><a class="dropdown-item" href="{{ route('user#profilePage') }}"> <i class="fa-regular fa-id-card"></i> Profile</a></li>
                                  ...
                                  <li class="my-2">
                                    <span class="dropdown-item">
                                        <form action="{{ route('logout') }}" method="POST" class="d-inline">
                                            @csrf
                                            <button class=" btn btn-secondary text-white" type="submit"> <i class="fa-solid fa-right-from-bracket"></i> Logout</button>
                                        </form>
                                    </span>
                                  </li>
                                </ul>
