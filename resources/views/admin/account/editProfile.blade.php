                                        ...
                                        <div class="row">
                                            <div class="col-4 offset-1">
                                                @if (Auth::user()->image == null)
                                                    <img src="{{ asset('images/default-user.jpg') }}" class="shadow rounded img-thumbnail" alt="default-user img">
                                                @else
                                                    <img src="{{ asset('storage/'.Auth::user()->image) }}" class="shadow rounded img-thumbnail" alt="">
                                                @endif
