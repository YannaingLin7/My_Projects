            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a class=" text-decoration-none" href="{{ route('admin#userList') }}">
                                <i class="fa-solid fa-clipboard-list"></i>User List
                            </a>
                        </li>
                        <li>
                            <a class=" text-decoration-none" href="{{ route('contact#message') }}">
                                <i class="fa-solid fa-envelope"></i> Users' Messages
                            </a>
                        </li>
                    </ul>
                </nav>
                                        ...
                                        <div class="image">
                                            @if (Auth::user()->image == null)
                                                @if (Auth::user()->gender == 'male')
                                                    <img src="{{ asset('images/default-user-male.jpg') }}">
                                                @else
                                                    <img src="{{ asset('images/default-user-female.png') }}">
                                                @endif
                                            @else
